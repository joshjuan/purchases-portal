        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    ...
                    <h2 data-aos="fade-up" data-aos-delay="400"> A new generation online cash register substitute of
                        Electronic Fiscal Device (EFD) designed for issurance of TRA Authorized fiscal receipts by
                        taxpayers in a real time.
                    </h2>
            ...
            <div class="row gx-0">
                <div class="col-lg-12 d-flex flex-column justify-content-center" data-aos="fade-up"
                    ...
                    <div class="content">
                        ...
                        <p class="text-center">
                            Virtual Fiscal Device is a new generation online cash register substitute of Electronic
                            Fiscal Device designed for issuance of fiscal digital receipts by taxpayers for every sale
                            transaction through online and signed by the tax administrator server in
                            real-time.
                        </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="box" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <p>The application is available online in which the tax payer (business person) in addition to
                            being able to make various transactions and register products, is also able to see
                            individual sales of all store..... .
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 mt-4 mt-lg-0">
                    <div class="box" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <h3>WEB VFD POS</h3>
                        <p>The application is available on the POS device on which the tax payer (business person) is
                            able to register their products, make sales and print fiscal receipts in real-time through
                            the device..</p>
                    </div>
                </div>
                <div class="col-lg-4 mt-4 mt-lg-0">
                    <div class="box" data-aos="fade-up" data-aos-delay="600">
                        ...
                        <p>The application system is available on the mobile application on which the tax payer
                            (business person) is able to install on their phone, register products, make sales and print
                            fiscal receipts..
                    </div>
                </div>
            </div>
                    ...
                    <div class="accordion accordion-flush" id="faqlist1">
                        <div class="accordion-item">
                            ...
                            <div id="faq-content-1" class="accordion-collapse collapse" data-bs-parent="#faqlist1">
                                <div class="accordion-body">
                                    WebVFD is an application system that�s been developed and directly connected to TRA
                                    tax administrator server to enable the tax payer easily issuing of fiscal receipts
                                    with QR Code in real-time.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist1">
                                <div class="accordion-body">
                                    WebVFD-POS The application is available on the POS device on which the tax payer
                                    (business person) is able to register their products, make sales and print receipts
                                    through the device.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="faq-content-3" class="accordion-collapse collapse" data-bs-parent="#faqlist1">
                                <div class="accordion-body">
                                    The application system is available on the mobile application on which the tax payer
                                    (business person) is able to install on their phone, register products, make sales
                                    and print receipts through the device, and send receipts to clients through email,
                                    or what�s app, etc
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="accordion accordion-flush" id="faqlist2">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq2-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist2">
                                <div class="accordion-body">
                                    Yes, currently we are develeping API that will allow third-part applications
                                    integration to WebVFD portal.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="faq2-content-3" class="accordion-collapse collapse" data-bs-parent="#faqlist2">
                                <div class="accordion-body">
                                    ...
                                    <br> 1. TIN Certificate TIN Owner ID (NIDA, Driving Licence, Passport, Voter�s ID)
                                    Business License UIN Form (well filled and signed by business owner)
