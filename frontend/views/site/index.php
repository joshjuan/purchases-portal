		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 d-flex flex-column justify-content-center">
					<h2 data-aos="fade-up">WebVFD Solution</h2>
					<h3 data-aos="fade-up" data-aos-delay="400">A new generation online
						cash register substitute of Electronic Fiscal Device (EFD)
						designed for issurance of TRA Authorized fiscal receipts by
						taxpayers in a real time.</h3>
					...
					<div class="row gy-4" data-aos="fade-left">
						...
						<div class="col-lg-4 col-md-6" data-aos="zoom-in"
							...
							<div class="box">
								...
								<div class="price">
									<sup>TSH</sup>60,000<span> / year</span>
								</div>
								<img src="assets/img/pricing-starter.png" class="img-fluid"
									alt="">
								<ul>
								...
								<button type="button" class="btn btn-buy" data-toggle="modal"
									data-target="#exampleModalLong">Buy Now</button>
							</div>
						</div>
						<div class="col-lg-4 col-md-6" data-aos="zoom-in"
							data-aos-delay="300">
							<div class="box">
								...
								<div class="price">
									<sup>TSH</sup>120,000<span> / year</span>
								</div>
						...
						<div class="col-lg-4 col-md-6" data-aos="zoom-in"
							...
							<div class="box">
								...
								<div class="price">
									<sup>TSH</sup>310,000<span> / year</span>
								</div>
						...
						<div class="accordion-item">
							...
							<div id="faq-content-1" class="accordion-collapse collapse"
								...
								<div class="accordion-body">WebVFD is an application system
									...
									fiscal receipts with QR Code in real-time.</div>
							</div>
						</div>
						<div class="accordion-item">
							<h2 class="accordion-header">
							...
							<div id="faq-content-2" class="accordion-collapse collapse"
								...
								<div class="accordion-body">WebVFD-POS The application is
									...
									print receipts through the device.</div>
							</div>
						</div>
						<div class="accordion-item">
							<h2 class="accordion-header">
							...
							<div id="faq-content-3" class="accordion-collapse collapse"
								...
								<div class="accordion-body">The application system is available
									...
									receipts to clients through email, or what�s app, etc</div>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="accordion-item">
							<h2 class="accordion-header">
								<button class="accordion-button collapsed" type="button"
									...
									i integrate WebVFD account with third party applications?</button>
							</h2>
						...
						<div class="accordion-item">
							<h2 class="accordion-header">
								<button class="accordion-button collapsed" type="button"
									...
									I know the procedures to get a new WebVFD account?</button>
							</h2>
			...
			<div class="clients-slider swiper-container">
				<div class="swiper-wrapper align-items-center">
					<div class="swiper-slide">
						<img src="assets/img/tra.jpg" class="img-fluid" alt="">
					</div>
					<div class="swiper-slide">
						<img src="assets/img/ura.png" class="img-fluid" alt="">
					</div>
					<div class="swiper-slide">
						<img src="assets/img/brand.jpg" class="img-fluid" alt="">
					</div>
					<div class="swiper-slide">
						<img src="assets/img/zrb.png" class="img-fluid" alt="">
					</div>
				</div>
